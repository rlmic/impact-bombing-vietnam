...
log using war-analysis_sep09, t replace;


/* TED EDITS, SEPT 14, 2005:
(i) ADDED DEFINIITIONS OF GLOBAL VARIABLES UPFRONT
(ii) ADDED CONLEY CODE IN TWO PLACES
*/;

/* TED EDITS, AUG 09, 2006:
(i) EXAMINE 1976-1984 POPULATION FIGURES (INCOMPLETE)
*/;

/* TED EDITS, SEP 2009:
(i) Deal with JDE referee reports
(ii) Include GINI coefficient in the analysis
...
*/;


/*This program analyzes two data files:*/;
/*District level: war_data_district_sep09, and */;
/*Province level: war_data_province_sep09*/;

/* TABLE 1 and 2: SUMMARY STATISTICS */;
use war_data_district_sep09, clear;
...
desc
	...
	$x_weather $x_oth $x_elev $x_gis $x_soil1 $x_soil2
	log_popdensity* popdensity* log*paddy* paddyyield* births* south* region
	pop_tot pop_prov sample* central rural diff_17*;
...
summ
	...
	educyr98_head educyr98father educyr98mother
	farm notbornhere yrshere 
	/* dkinh dchinese */ /* disabled */ /* vetassoc irr_frac */
	$ord0 $ord1 $ord2 $ord3 $ord3_per /* $ord4 $ord5 $ord6 $ord7 $ord8 */
	log_tot_bmr* tot_bmr* tot_bomb* war_f1 war_f2
	$x_weather $x_oth $x_elev $x_gis $x_soil1 $x_soil2
	log_popdensity* popdensity* log*paddy* paddyyield* births* south* region
...
use war_data_province_sep09, clear;
summ if sample_all==1;

clear;

/* Table 3 - Predicting bomb intensity*/;
/* PREWAR ANALYSIS - WHERE DID THE BOMBS FALL? */;


/* REGIONS: 	1=RED RIVER DELTA, 2=NORTHEAST, 3=NORTHWEST, 8=MEKONG RIVER DELTA 4=NORTH CENTRAL COAST, 5=SOUTH CENTRAL COAST, 6=CENTRAL HIGHLANDS, 7=NORTHEAST SOUTH  */;

/* PROVINCE LEVEL */;
foreach vio in 
	tot_bmr_per /* mine_per log_tot_bmr tot_bmr tot_bmr_hi General_Purpose war_f1 */
{;
use war_data_province_sep09;
/* DO NOT INCLUDE SOIL TYPE CONTROLS IN PROVINCE LEVEL REGRESSIONS, DUE TO DEGREES OF FREEDOM ISSUES */;
regress `vio'
	south
	popdensity6061
...
*twoway (scatter popdensity6061 `vio', mlabel(provincename) mlabp(12)) /*(lfit popdensity6061 `vio')*/ if central==1, saving(popdensity_lin_`vio'C, replace);
clear;
...
{;
replace invest_`num' = invest_`num';
...
twoway (connected q1_ year, ml(lab1) mlabp(12)) (connected q2_ year, ml(lab2) mlabp(12)) (connected q3_ year, ml(lab3) mlabp(12)) (connected q4_ year, ml(lab4) mlabp(12)), /*ylabel(0(100)600)*/ l1title("Investment (in current Dong)") saving(invest_19851976, replace);

twoway (connected ratio2 year, ml(lab2) mlabp(12)) (connected ratio3 year, ml(lab3) mlabp(12)) (connected ratio4 year, ml(lab4) mlabp(12)),
	/* ylabel(0(100)600) */ l1title("Investment ratio (in current Dong)") saving(invest_ratio_19851976, replace);

twoway (connected ratio34 year, mlabp(12)),
	ylabel(1(0.5)3) l1title("State investment") saving(invest_median_19851976, replace);
