...
desc
	...
	rlpcex1 rlpcex1_93 CONSGROWTHPC
	avg_ill4wks literate numerate educyr98father educyr98mother
	farm notbornhere
...
foreach var in
	...
	rlpcex1 rlpcex1_93 CONSGROWTHPC
	avg_ill4wks /* literate */ educyr98father /* educyr98mother */
	/* factory */ farm notbornhere
{;
...
/* MEDIAN POPULATION DENSITY 200 (UNITS?) */;
areg `var' `vio'
	[aw=pop_tot]
	if (popdensity6061>=200 & popdensity6061~=.), a(province) robust cluster(province);
bys south: areg `var' `vio'
	[aw=pop_tot]
	if popdensity6061<200, a(province) robust cluster(province);
